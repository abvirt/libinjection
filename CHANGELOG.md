...
## [4.1.0](https://github.com/abvirt/libinjection/compare/v4.0.0...v4.1.0) (2026-09-23)


### Features

* **analyzer:** use newer ArrayBoundsV2 check ([7e7c29b](https://github.com/abvirt/libinjection/commit/7e7c29b09b7db2a4a35583ceb7a923de19306059))
* **build:** add autotools support ([efa9b30](https://github.com/abvirt/libinjection/commit/efa9b306deae08d1b39f5529c3d597120a7e71a2))
* lint and fix code using clang-format ([73268cf](https://github.com/abvirt/libinjection/commit/73268cfd85f9ee625e1d73ec2b37672bb2fd83f6))
* lint and fix code using clang-format ([141ec39](https://github.com/abvirt/libinjection/commit/141ec3954b424ee9b8b58124237198c900b483fb))
* lint and fix code using clang-format ([a0131c0](https://github.com/abvirt/libinjection/commit/a0131c02e46add68e6704478bfd964389c153bb6))
* **py3:** update build syntax to py3 ([546665c](https://github.com/abvirt/libinjection/commit/546665c0390902acee4593614bd5f5346fd359f6))
* update docs and swig bindings ([86b8a68](https://github.com/abvirt/libinjection/commit/86b8a68b947605b0ab37cb78ef8ebec7cb90d2f4))
* use error return code in place of assert/abort ([837baea](https://github.com/abvirt/libinjection/commit/837baea5385384245f8d69731358fa8424507070))
* use error return code in place of assert/abort ([30f9926](https://github.com/abvirt/libinjection/commit/30f99268fdc5346616a8b965fa1a43a126be5d2d))


### Bug Fixes

* add back onbeforeactivate, onpropertychange ([76e2b71](https://github.com/abvirt/libinjection/commit/76e2b7135259b79cdad966309109cee126314775))
* add func prototype to fix linting ([2c3c2d9](https://github.com/abvirt/libinjection/commit/2c3c2d989231fc968e5794be9f5f0c78a7213887))
* add link to event names source ([e95c0b5](https://github.com/abvirt/libinjection/commit/e95c0b52a3828e81e035cafc041be5ba5ac86b74))
* add unit tests for html decode fix ([4ae437f](https://github.com/abvirt/libinjection/commit/4ae437f4d83ae174bc467f08000267a6618adeb0))
* additional table format ([973ca1e](https://github.com/abvirt/libinjection/commit/973ca1e80f1ee05761a8fcd270a54c8fd0fe2d27))
* address code review comment ([8576be6](https://github.com/abvirt/libinjection/commit/8576be6a4305cd4680c08bb74a145ceedebc8e81))
* **analyzer:** deal with clang analyzer findings ([89a3de5](https://github.com/abvirt/libinjection/commit/89a3de5adaf0daad5f359b2d92194f343bf960c1))
* apply clang format ([a7f2d1f](https://github.com/abvirt/libinjection/commit/a7f2d1f7341b1612edd243165134ef45d3364ee5))
* apply clang-format ([285fe53](https://github.com/abvirt/libinjection/commit/285fe538e115c841c5374e21e376d391b1417c44))
* apply clang-format ([4294a49](https://github.com/abvirt/libinjection/commit/4294a49d72532ea187f99a04043cced8923a5001))
* apply code review comment ([ffb2fbd](https://github.com/abvirt/libinjection/commit/ffb2fbdaccc136617bd389ffd628f684f35503db))
* apply core review suggestion ([be4f03f](https://github.com/abvirt/libinjection/commit/be4f03f865a57fc63b5ba1a3b487f5477b813237))
* apply suggestion from code review ([da6f42f](https://github.com/abvirt/libinjection/commit/da6f42f20ea37082add09644c729e82e3d0e5395))
* **build:** fix warnings at compile time ([9de04b7](https://github.com/abvirt/libinjection/commit/9de04b78b91e923b5a197d9e53bba5094b510f99))
* **build:** move some helpers to makefile ([4172976](https://github.com/abvirt/libinjection/commit/417297685fa35ab5130339c3f98f60eebf9f8aed))
* bump artifact version v4 ([66048d7](https://github.com/abvirt/libinjection/commit/66048d73c7832d42440e313137342710aaa3331f))
* clang format ([4080228](https://github.com/abvirt/libinjection/commit/4080228e6e8099e348593096035cc5aca007de73))
* cppcheck issues ([d7dd56f](https://github.com/abvirt/libinjection/commit/d7dd56f26968591e59a61d10d2bec260081639f6))
* **cppcheck:** update var name to match check ([92bb516](https://github.com/abvirt/libinjection/commit/92bb5161f29bbd67269cc5c00e8a6623a5f4f4e0))
* detect 1.e or 1.E SQLI issue ([52f9aef](https://github.com/abvirt/libinjection/commit/52f9aef2e7aee4f53021c48d5d2dea585414789e))
* embedding version ([51f3a96](https://github.com/abvirt/libinjection/commit/51f3a96e9fcc90a6112f52ac96fd4661e7ab0a44))
* format align ([f6eec9f](https://github.com/abvirt/libinjection/commit/f6eec9fc71f9b82f5f6255f85d9f9e8332bad9ba))
* **fuzzing:** add -fsanitize=fuzzer-no-link ([61a0455](https://github.com/abvirt/libinjection/commit/61a045507bb543c4c3d42a0ffa3a1d7b3038b2d8))
* **fuzzing:** add -fsanitize=fuzzer-no-link ([59538c3](https://github.com/abvirt/libinjection/commit/59538c3ee38953318865ab707c222a441a5f52e6))
* golang memory leak ([271bf39](https://github.com/abvirt/libinjection/commit/271bf395732dcf6fd3689d0d456813018661e48f))
* make clang analyzer happy ([fa0387d](https://github.com/abvirt/libinjection/commit/fa0387d692e4d9b78c3fdc1193d9a64a8ee2f7d7))
* move preprocessor flags to cover whole function ([de8a7ba](https://github.com/abvirt/libinjection/commit/de8a7baa1d766b99f285fefee28b856c1945481f))
* move version back to c file to allow embedding ([60bde2b](https://github.com/abvirt/libinjection/commit/60bde2bcddfc635f83263e0fd78c227706843a49))
* potentially missing parenthesis in solar empire blind injection. ([30919be](https://github.com/abvirt/libinjection/commit/30919be1ee16bd9115b8c74a942cd3aa674a785a))
* rebase and address review comment ([a868c14](https://github.com/abvirt/libinjection/commit/a868c14f87f39141746c2c22c2a6a1ef77a50cc3))
* rebase leftovers ([02e3e91](https://github.com/abvirt/libinjection/commit/02e3e917e135753cb3281db004db89d57cabed3e))
* run clang-format ([842be96](https://github.com/abvirt/libinjection/commit/842be963128d1f12da6d8fe14b2a88e68de27966))
* set correct length of added argument ([ff27bd0](https://github.com/abvirt/libinjection/commit/ff27bd0ba155d1de83b30ae8ae42c02ccedd3742))
* set correct length of added argument ([1836237](https://github.com/abvirt/libinjection/commit/18362370d2531480a81aafb46a48272820739ad7))
* tests for 1.e sqli ([380d95e](https://github.com/abvirt/libinjection/commit/380d95e08485989abd23f583ae2937dd64509115))
* try cstrcasecmp_with_null with another way ([c017af0](https://github.com/abvirt/libinjection/commit/c017af0c7c345ed8cec3ce477375c5bedead570c))
* update null terminated strings comment and fuzzer code ([b9fcaaf](https://github.com/abvirt/libinjection/commit/b9fcaaf9e50e9492807b23ffcc6af46ee1f203b9))
* update test suite to reflect events update ([51796ef](https://github.com/abvirt/libinjection/commit/51796efdbf078c19008c3983817eb0496fccc546))
* use correct boundary check in html_decode_char_at() ([22dc5ba](https://github.com/abvirt/libinjection/commit/22dc5babe1242d5edebd875fb3dc45e1f117c830))
* use version if not defined ([5b69919](https://github.com/abvirt/libinjection/commit/5b69919656b7ea8c3a285ea5255fb8f7736c8ce8))
